...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-900/20 to-orange-800/30 dark:from-gray-900 dark:to-gray-800 p-4">
